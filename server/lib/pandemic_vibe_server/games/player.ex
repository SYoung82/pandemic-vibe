defmodule PandemicVibeServer.Games.Player do
  use Ecto.Schema
  ...
  schema "players" do
    ...
    belongs_to :user, PandemicVibeServer.Accounts.User
    belongs_to :current_city, PandemicVibeServer.Games.City
  ...
  def changeset(player, attrs) do
    player
    |> cast(attrs, [:role, :turn_order, :actions_remaining, :game_id, :user_id, :current_city_id])

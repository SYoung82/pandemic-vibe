defmodule PandemicVibeServer.Games.Game do
  use Ecto.Schema
  ...
  schema "games" do
    ...
    belongs_to :created_by, PandemicVibeServer.Accounts.User
    has_many :players, PandemicVibeServer.Games.Player
    has_many :game_states, PandemicVibeServer.Games.GameState

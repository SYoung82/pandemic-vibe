defmodule InfestationServer.Games.Card do
  use Ecto.Schema
  ...
  schema "cards" do
    ...
    belongs_to :player, InfestationServer.Games.Player
  ...
  def changeset(card, attrs) do
    card
    |> cast(attrs, [:card_type, :location, :position, :game_id, :planet_id, :player_id])
